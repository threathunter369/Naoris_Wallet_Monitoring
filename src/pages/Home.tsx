...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white flex flex-col font-sans selection:bg-brand-primary selection:text-black">
      {/* Background Animated Dotted Surface */}
      <DottedSurface />
        ...
        <div className="max-w-6xl mx-auto w-full relative z-10">
          <div className="flex flex-col md:flex-row items-center gap-20">
            <div className="flex-1 space-y-8">
              ...
              >
                MONITORING <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-primary via-emerald-400 to-white">SIMPLIFIED</span>
              </motion.h1>
